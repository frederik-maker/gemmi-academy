...
import { Globe, RotateCcw, Heart, GraduationCap, Gem, Check, Users, Download, Loader2, Info } from 'lucide-react'
      ...
      blocks: [
        ...
        },
        {
          ...
          ps: [
            ...
            'On-device AI: Gemma 4 E4B (fine-tuned) running via LiteRT-LM in a Capacitor Android plugin.',
      ...
      blocks: [
        ...
        },
        {
          ...
          ps: [
            ...
            'On-device ИИ: Gemma 4 E4B (fine-tune) через LiteRT-LM в Capacitor-плагине.',
      ...
      blocks: [
        ...
        },
        {
          ...
          ps: [
            ...
            'On-device ИИ: Gemma 4 E4B (fine-tune), LiteRT-LM-да Capacitor плагині арқылы.',
